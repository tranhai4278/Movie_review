        ...
        <div className="left_col scroll-view" style={{position: 'fixed', height: "100vh"}}>
          <Navbar.Brand style={{width: '230px'}}>
            <Link to="/" style={{textDecoration: 'none'}}>
              <img className="logo" src="/images/logo1.png" alt="Logo" width="160" height="58" />
            </Link>
          </Navbar.Brand>
          ...
          <div id="sidebar-menu" className="main_menu_side hidden-print main_menu" style={{marginTop: '40px'}}>
